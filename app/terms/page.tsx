    ...
    <div className="legal-page">
      ...
      <main className="legal-content">
        <div className="legal-container">
          ...
          <section>
            <h2>9. Medical Industry & Disclaimer</h2>
            <h3>9.1 Not a Medical Device</h3>
            <p>
              The Service utilizes Artificial Intelligence to analyze conversations for coaching and quality assurance purposes only. <strong>The Service is NOT a medical device</strong> and should not be used for:
            </p>
            <ul>
              <li>Medical diagnosis or treatment decisions</li>
              <li>Clinical documentation without physician review</li>
              <li>Emergency response or triage</li>
            </ul>
            <p>
              Any insights regarding patient symptoms, conditions, or treatments are generated by AI and may be inaccurate. Professional medical judgment must always supersede AI analysis.
            </p>

            <h3>9.2 Patient Consent & Compliance</h3>
            <p>
              If you use the Service to process Protected Health Information (PHI) or sensitive personal data:
            </p>
            <ul>
              <li>You represent and warrant that you have obtained all necessary patient consents for recording and third-party analysis, in compliance with applicable laws (including HIPAA, GDPR, and DPDP Act).</li>
              <li>You agree not to upload data if such consent has not been obtained.</li>
              <li>You are responsible for executing a Business Associate Agreement (BAA) with us if required by your jurisdiction.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms shall be governed by and construed in accordance with the laws of India, without regard to its conflict of law provisions. Any disputes arising from these Terms shall be resolved in the courts of Bengaluru, India.
            </p>
          </section>
